...
1. **Install LEMP Stack** - Install Nginx, MySQL, PHP, and Composer
2. **Uninstall Components** - Remove specific components or entire stack
3. **Check Installation Status** - View what's currently installed
